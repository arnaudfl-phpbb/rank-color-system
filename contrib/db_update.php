...
$sql[] = 'INSERT INTO ' . $table_prefix . 'rcs VALUES(1,\'Administrator\',\'CC0000\',0,0,10)';
$sql[] = 'ALTER TABLE ' . $table_prefix . 'groups ADD group_color MEDIUMINT(8) NOT NULL DEFAULT 0';
$sql[] = 'ALTER TABLE ' . $table_prefix . 'users ADD user_color MEDIUMINT(8) NOT NULL DEFAULT 0';
$sql[] = 'ALTER TABLE ' . $table_prefix . 'users ADD user_group_id MEDIUMINT(8) NOT NULL DEFAULT 0';
...
$sql[] = 'INSERT INTO ' . $table_prefix . 'config(config_name,config_value) VALUES(\'rcs_level_admin\',\'1\')';
$sql[] = 'INSERT INTO ' . $table_prefix . 'config(config_name,config_value) VALUES(\'rcs_level_mod\',\'1\')';
$sql[] = 'INSERT INTO ' . $table_prefix . 'config(config_name,config_value) VALUES(\'rcs_ranks_stats\',\'1\')';
$sql[] = 'ALTER TABLE ' . $table_prefix . 'themes ADD rcs_admincolor VARCHAR(6) NOT NULL DEFAULT \'\'';
$sql[] = 'ALTER TABLE ' . $table_prefix . 'themes ADD rcs_modcolor VARCHAR(6) NOT NULL DEFAULT \'\'';
$sql[] = 'ALTER TABLE ' . $table_prefix . 'themes ADD rcs_usercolor VARCHAR(6) NOT NULL DEFAULT \'\'';
